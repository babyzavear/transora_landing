                ...
                <div className='container flex items-center justify-between'>
                    ...
                    <div className='flex items-center gap-3'>
                        <button
                            ...
                            className='hidden lg:flex items-center justify-center h-11 w-11 rounded-full border border-primary text-primary font-semibold text-sm hover:bg-primary hover:text-white transition duration-300'>
                            {lang === 'id' ? 'EN' : 'ID'}
                        </button>
                        <Link
                            href='#features'
                            className='hidden lg:block bg-transparent text-primary border hover:bg-primary border-primary hover:text-white px-8 py-5 rounded-full font-medium text-lg'>
                            {t.header.ctaSecondary}
                        </Link>
                        <Link
                            href={getWhatsAppLink(lang)}
                            target='_blank'
                            className='hidden lg:block bg-primary text-white hover:bg-transparent hover:text-primary border border-primary px-8 py-5 rounded-full font-medium text-lg'>
                            {t.header.ctaPrimary}
                        </Link>
                        <button
